...
var controller = {
    ...
    saveProject: function (req, res) {
        ...
        project.save((err, projectStored) => {
            ...
            if (!projectStored) return res.status(404).send({ mesagge: 'No se ha podido guardar el El formulario' });
    ...
    getProject: function (req, res) {
        ...
        Project.findById(projectId, (err, project) => {
            ...
            if (!project) return res.status(404).send({ mesagge: 'El proyecto no existe' });
        ...
        if (req.files) {
            ...
            if (fileExt == 'png' || fileExt == 'jpg' || fileExt == 'jpeg' || fileExt == 'gift') {
                ...
                project.findByIdAndUpdate(projectId, { image: fileName }, { new: true }, (err, projectUpdated) => {
                    ...
                    return res.status(200).send({
                        project: projectUpdated, filepath
